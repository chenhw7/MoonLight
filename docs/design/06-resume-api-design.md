...
| POST | `/resumes/{id}/projects` | 添加校园经历 | 是 |
| PUT | `/resumes/{id}/projects/{proj_id}` | 更新校园经历 | 是 |
| DELETE | `/resumes/{id}/projects/{proj_id}` | 删除校园经历 | 是 |
...
4. POST /resumes/{id}/projects      # 添加校园经历（可多次）
