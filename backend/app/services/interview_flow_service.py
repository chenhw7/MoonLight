...
class InterviewFlowService:
    ...
    ROUND_TRANSITION_MARKERS = {
        "opening": ["[NEXT:self_intro]", "请开始自我介绍", "请先介绍一下"],
        "self_intro": ["[NEXT:qa]", "接下来进入技术问答", "让我们开始技术问题"],
        "qa": ["[NEXT:reverse_qa]", "你有什么问题要问我吗", "反问环节"],
        "reverse_qa": ["[NEXT:closing]", "面试到此结束", "今天的面试就到这里"],
    }
    ...
    def get_round_instruction(cls, round_name: str) -> str:
        ...
        instructions = {
            ...
            "self_intro": "当前是【自我介绍】轮次。\n"
                         ...
                         "追问结束后，说：接下来我们进入技术问答环节。",
            "qa": "当前是【核心问答】轮次。\n"
                 "根据面试模式进行技术提问，每次只问一个问题。\n"
                 "总共问 5-10 个问题，根据候选人回答进行追问。\n"
                 "问完后，说：你有什么问题要问我吗？",
            "reverse_qa": "当前是【反问环节】。\n"
                         "让候选人提问，回答他们关于公司、团队、岗位的问题。\n"
                         "回答 0-5 个问题后，结束面试。\n"
                         "结束时说：今天的面试就到这里，感谢你的参与。",
            "closing": "当前是【结束】轮次。\n"
